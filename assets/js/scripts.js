/**
 * @Package: Sri Thirumala Transport Admin HTML Theme
 * @Since: Sri Thirumala Transport 1.0
 * This file is part of Sri Thirumala Transport Admin Theme HTML package.
 */
        ...
        $('.page-chatapi .user-row').on('click', function() {
            ...
            if ($(this).hasClass("active")) {
                ...
                if ($(".chatapi-windows #user-window" + id).length) {
                    ...
                    msg += chatformat_msg('Yes! Sri Thirumala Transport Admin Theme ;)', 'sent', 'You');
