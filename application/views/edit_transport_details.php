                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            <div class="pull-left">
                                <h1 class="title">Edit Transport Details</h1>                            
                            </div>
                        </div>
                    </div>
                        ...
                        <section class="box nobox">
                            ...
                            <div class="row">
                               ...
                               <?php if($this->session->flashdata('success_msg')!=null){ ?>
                                ...
                                <?php echo form_open_multipart('transport_details/validate_edit_transport_details', array('class'=>'form-horizontal'));        
                                foreach ($transport_details_data->result() as $row)
                                {            
                                ?>
                          ...
                          <input type="hidden" id="id" name="id" value="<?php echo $row->Transport_dtl_id; ?>">
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">              
                              <?php 
                                  $data2 = array(
                                        'name'        => 'phone_no',
                                        'id'          => 'phone_no',
                                        'value'       => $row->Transport_dtl_phone_no,
                                        'maxlength'   => '20',
                                        'class'       => 'form-control',
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">             
                              <?php echo form_textarea('address', $row->Transport_dtl_address , 'class="form-control" id="area" cols="5" rows="5"'); ?>
                            </div>
                          </div> 
                                  <div class="form-group">
