...
<head>
        ...
        <div class="page-container row-fluid">
            ...
            <section id="=main-content" class=" ">
                <section class="wrapper =main-wrapper" style=''>
                    ...
                    ?>
                    <div class="col-lg-12">
                     <?php echo form_open_multipart('transport_payment/view_transport_payments_unpaid_print?id='.$id.'', array('class'=>'form-horizontal')); ?>
                         ...
                         <!-- start mail box for read daily movement details -->
                               ...
                               <section class="box ">
                                      <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                            <h3 class="text-center"><strong>Transport Unpaid Bills</strong></h3>
	...
	$mvnt_balc = $row->Daily_mvnt_dtl_trp_rent-$row->Daily_mvnt_dtl_trp_adv;
     ...
     <!-- end mail box for read daily movement details -->   
                              <h4><strong>Unpaid Bills Amount (<i class="fa fa-inr"></i>)</strong> :&nbsp;<span class="text-primary">
