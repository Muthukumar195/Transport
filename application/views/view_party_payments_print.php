        ...
        <div class="page-container row-fluid">
            ...
            <section id="=main-content" class=" ">
                <section class="wrapper =main-wrapper" style=''>
                    ...
                    ?>
                    <div class="col-lg-12">
                     <?php echo form_open_multipart('party_payments/view_party_payments_print?id='.$id.'&pr_nme='.$pr_nme.'', array('class'=>'form-horizontal')); ?>
                                            ...
                                            ?>
                                                <tr>
                                                 ...
                                                 <?php echo $row->Vehicle_dtl_number;  ?>
                                                  ...
                                                  <td><?php if($row->Daily_mvnt_dtl_container_type=='NC'){
