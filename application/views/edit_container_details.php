...
?>
                ...
                <section class="wrapper main-wrapper" style=''>
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            <div class="pull-left">
                                <h1 class="title">Edit Container Details</h1>                            
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
       ...
       <?php if($this->session->flashdata('success_msg')!=null){ ?>
        ...
        <?php echo form_open_multipart('container_details/validate_edit_container_details', array('class'=>'form-horizontal'));        
        foreach ($container_details_data->result() as $row)
        {            
        ?>
            ...
            <div class="col-lg-8">              
              <?php
                   $data1 = array(
                        ...
                        'id'          => 'container_number',
                        'value'       => $row->Container_dtl_container_no,
                        'maxlength'   => '160',
                        'class'       => 'form-control',
              ...
              ?>
              <input type="hidden" id="id" name="id" value="<?php echo $row->Container_dtl_id; ?>">
           </div>
          </div>
        <div class="form-group">
            ...
            <div class="col-lg-8">              
              <?php
                ...
                echo form_dropdown('container_size', $options, $row->Container_dtl_size, $class_nme);
              ?>
            </div>
          </div>
          <div class="form-group">
