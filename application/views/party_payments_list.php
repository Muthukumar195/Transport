        ...
        <div class="page-container row-fluid">
            ...
            <section class="wrapper main-wrapper" style=''>
                   <div class="col-lg-12">
                           ...
                           <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Iso Payments List</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <!-- <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i> -->
                                    <i class="box_close fa fa-times"></i>
                            ...
                            <div class="content-body">    <div class="row">
                                ...
                                <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php 
                                        $sno=1;                                                    
                                       foreach ($party_iso_payment_list->result() as $row)
                                        {                                                               
                                    ?>
                                        <tr>
                                            <td><?php  echo $sno; ?></td>
                                            ...
                                            <td><?php if($row->Iso_mvnt_vehicle_type=='T'){ echo $row->Iso_mvnt_vehicle_no;}else{echo $row->Iso_mvnt_other_vehicle_no;} ?>
                                            </td>
                                            <td><?php echo $row->Iso_mvnt_pickup_place.'-'.$row->Iso_mvnt_drop_place; ?></td>
                                            <td>
                                            <?php if($row->Iso_mvnt_container_type=="F"){
                                            ...
                                            <td>
                                                 <?php
                                                echo anchor('party_payments/view_party_payments?id='.$row->Party_dtl_id.'&pr_nme='.$row->Party_dtl_name.'','View','class="fa fa-search-plus" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn" data-toggle="tooltip" data-original-title="Click To View" data-placement="bottom"');
                                                ?>                                               
