...
?>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Add Vehicle Details</h1>                            </div>
    ...
    <div class="row">
       ...
       <?php if($this->session->flashdata('success_msg')!=null){ ?>
        ...
        <?php echo form_open_multipart('vehicle_details/validate_vehicle_details', array('class'=>'form-horizontal')); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">             
              <?php 
				 ...
				 echo form_dropdown('trans_name',$option_trans,'','class="form-control" id="trans_name"');
              ?>
            </div>
          </div>
...
include('validation/add_vehicle_details.php');
?>
